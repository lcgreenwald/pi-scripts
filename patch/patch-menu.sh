...
false "PythonGPS20211119" "$PythonGPS20211119" "Install Python GPS and update Conky files" \
--button="Exit":1 \
...
PATCHAPPS=(hamlib4dot3dot1date20211105 ConkyDesktops20211112 PythonGPS20211119)
for i in "${PATCHAPPS[@]}"
do
echo "$i" >> ${PATCH}
done
